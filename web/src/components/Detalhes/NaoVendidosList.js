...
const NaoVendidosList = () => {
  ...
  useEffect(() => {
    let mounted = true;
    getApi.getDetalhesNaoVendidos(page)
      .then(res => {
        if (mounted) {
  ...
  return (
    <div className={classes.root}>
      <Typography variant="h4">Listagem de Veículos Não Vendidos </Typography>
...
export default NaoVendidosList;